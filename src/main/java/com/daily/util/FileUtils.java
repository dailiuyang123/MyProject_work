...
public class FileUtils {
    ...
    *
    **/
    public void ImageZip(HttpServletRequest request, HttpServletResponse response){

        String queryString = request.getQueryString();
        System.out.println("GET 请求绑定在URL上的参数:"+queryString);                //GET 请求绑定在URL上的参数
        //创建文件上传 组件
        ...
        try {
            ...
            for (FileItem fileItem : fileItems) {
                ...
                String path="D:\\";
                Thumbnails.of(inputStream).scale(0.25f).toFile(path+fileName);
            }
